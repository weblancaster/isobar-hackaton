...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */var CSSCore={ /**
	   ...
	   */addClass:function addClass(element,className){ true?invariant(!/\s/.test(className),'CSSCore.addClass takes only a single class name. "%s" contains ' + 'multiple classes.',className):invariant(!/\s/.test(className));if(className){if(element.classList){element.classList.add(className);}else if(!CSSCore.hasClass(element,className)){element.className = element.className + ' ' + className;}}return element;}, /**
	   * Removes the class passed in from the element
	   *
	   * @param {DOMElement} element the element to set the class on
	   * @param {string} className the CSS className
	   * @return {DOMElement} the element passed in
	   */removeClass:function removeClass(element,className){ true?invariant(!/\s/.test(className),'CSSCore.removeClass takes only a single class name. "%s" contains ' + 'multiple classes.',className):invariant(!/\s/.test(className));if(className){if(element.classList){element.classList.remove(className);}else if(CSSCore.hasClass(element,className)){element.className = element.className.replace(new RegExp('(^|\\s)' + className + '(?:\\s|$)','g'),'$1').replace(/\s+/g,' ') // multiple spaces to one
	.replace(/^\s*|\s*$/g,''); // trim the ends
	   ...
	   */hasClass:function hasClass(element,className){ true?invariant(!/\s/.test(className),'CSS.hasClass takes only a single class name.'):invariant(!/\s/.test(className));if(element.classList){return !!className && element.classList.contains(className);}return (' ' + element.className + ' ').indexOf(' ' + className + ' ') > -1;}};module.exports = CSSCore;},{"150":150}],5:[function(_dereq_,module,exports){ /**
	 * Copyright 2013-2015, Facebook, Inc.
	 * All rights reserved.
	 *
	 * This source code is licensed under the BSD-style license found in the
	...
	*/'use strict';var shallowEqual=_dereq_(166); /**
	...
	if(true){ true?warning(this.props.selected == null,'Use the `defaultValue` or `value` props on <select> instead of ' + 'setting `selected` on <option>.'):null;}},render:function render(){return option(this.props,this.props.children);}});module.exports = ReactDOMOption;},{"171":171,"32":32,"38":38,"63":63}],55:[function(_dereq_,module,exports){ /**
	 * Copyright 2013-2015, Facebook, Inc.
	 * All rights reserved.
	 *
	 * This source code is licensed under the BSD-style license found in the
	...
	*/'use strict';var ReactElement=_dereq_(63);var warning=_dereq_(171); /**
	 ...
	 * @param {object} obj
	 * @return {object}
	 */var keyMirror=function keyMirror(obj){var ret={};var key; true?invariant(obj instanceof Object && !Array.isArray(obj),'keyMirror(...): Argument must be an object.'):invariant(obj instanceof Object && !Array.isArray(obj));for(key in obj) {if(!obj.hasOwnProperty(key)){continue;}ret[key] = key;}return ret;};module.exports = keyMirror;},{"150":150}],157:[function(_dereq_,module,exports){ /**
	 * Copyright 2013-2015, Facebook, Inc.
	 * All rights reserved.
	 *
	 * This source code is licensed under the BSD-style license found in the
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var React = __webpack_require__(1),
	    StateTree = __webpack_require__(7),
	    Cursors = __webpack_require__(18),
	...
	var App = React.createClass({
	    ...
	    mixins: [StateTree.mixin, React.addons.PureRenderMixin],
	    cursors: {
	        app: Cursors.app
	    },
	    ...
	    render: function render() {
	        return React.createElement(
	            'section',
	            null,
	            React.createElement(Header, { appTitle: this.props.appTitle,
	                appSubTitle: this.props.appSubtitle,
	                version: this.props.version }),
	            React.createElement(Contols, null)
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./master.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./master.scss");
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @author B.Podczerwinski
	 */
	var Baobab = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Baobab = __webpack_require__(9),
	    Cursor = __webpack_require__(13),
	    Facet = __webpack_require__(16),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Baobab(initialData, opts) {
	  ...
	  if (!(this instanceof Baobab)) return new Baobab(initialData, opts);

	  if (!type.Object(initialData) && !type.Array(initialData)) throw Error('Baobab: invalid data.');
	  ...
	  // Immutable tree?
	  if (this.options.immutable) helpers.deepFreeze(this.data);
	  ...
	  // Facets
	  if (!type.Object(this.options.facets)) throw Error('Baobab: invalid facets.');

	  for (var k in this.options.facets) this.addFacet(k, this.options.facets[k]);
	}
	...
	Baobab.prototype.select = function (path) {
	  ...
	  if (arguments.length > 1) path = helpers.arrayOf(arguments);

	  if (!type.Path(path)) throw Error('Baobab.select: invalid path.');
	  ...
	  var hash = path.map(function (step) {
	    if (type.Function(step) || type.Object(step)) return '$' + uniqid() + '$';else return step;
	  }).join('|λ|');
	...
	Baobab.prototype.stack = function (spec, skipMerge) {
	  ...
	  if (!type.Object(spec)) throw Error('Baobab.update: wrong specification.');

	  if (!this.previousData) this.previousData = this.data;
	  ...
	  if (!this.options.asynchronous) return this.commit();

	  // Updating asynchronously
	  if (!this._future) this._future = setTimeout(self.commit.bind(self, null), 0);
	...
	Baobab.prototype.release = function () {
	  ...
	  // Releasing facets
	  for (k in this.facets) this.facets[k].release();
	  delete this.facets;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (data, spec, opts) {
	  ...
	  var mutator = function mutator(o, spec, path, parent) {
	    path = path || ['root'];
	    ...
	    if (leafLevel) {
	      ...
	      for (k in spec) {
	        ...
	        if (k === '$unset') {
	          ...
	          if (!type.Object(parent[olderKey])) throw makeError(path.slice(0, -1), 'using command $unset on a non-object');

	          parent[olderKey] = helpers.shallowClone(o);
	          delete parent[olderKey][lastKey];

	          if (opts.immutable) helpers.freeze(parent[olderKey]);
	          break;
	        }
	        ...
	        // $apply
	            ...
	            if (typeof fn !== 'function') throw makeError(path, 'using command $apply with a non function');
	          ...
	          // $merge
	              ...
	              if (!type.Object(o[lastKey]) || !type.Object(v)) throw makeError(path, 'using command $merge with a non object');
	        ...
	        if (k === '$splice') {
	          ...
	          if (!type.Array(o[lastKey])) throw makeError(path, 'using command $push to a non array');

	          for (i = 0, l = v.length; i < l; i++) o[lastKey] = helpers.splice.apply(null, [o[lastKey]].concat(v[i]));
	        }
	        ...
	        if (k === '$unshift') {
	          ...
	          if (!type.Array(o[lastKey])) throw makeError(path, 'using command $unshift to a non array');

	          o[lastKey] = [].concat(v).concat(o[lastKey]);
	        }

	        // Deep freezing the new value?
	        if (opts.immutable) helpers.deepFreeze(o);
	      }
	    } else {

	      // If nested object does not exist, we create it
	      if (type.Primitive(o[lastKey])) o[lastKey] = {};else o[lastKey] = helpers.shallowClone(o[lastKey]);

	      // Should we freeze the parent?
	      if (opts.immutable) helpers.freeze(o);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cloner(deep, item) {
	  ...
	  if (type.Array(item)) {
	    if (deep) {
	      var i,
	          l,
	          a = [];
	      for (i = 0, l = item.length; i < l; i++) a.push(deepClone(item[i]));
	      return a;
	    } else {
	      return item.slice(0);
	    }
	  ...
	  // Date
	  if (type.Date(item)) return new Date(item.getTime());
	  ...
	  if (type.Object(item)) {
	    ...
	    for (k in item) if (item.hasOwnProperty(k)) o[k] = deep ? deepClone(item[k]) : item[k];
	    return o;
	  }
	...
	function freezer(deep, o) {
	  ...
	  if (Array.isArray(o)) {
	    ...
	    for (i = 0, l = o.length; i < l; i++) deepFreeze(o[i]);
	  } else {
	    var p, k;
	...
	function compare(object, spec) {
	  ...
	  for (k in spec) {
	    if (type.Object(spec[k])) {
	      ...
	      if (object[k] !== spec[k]) return false;
	    }
	  }
	...
	function getIn(object, path, tree) {
	  ...
	  for (i = 0, l = path.length; i < l; i++) {
	    ...
	    if (typeof path[i] === 'function') {
	      if (!type.Array(c)) return;

	      c = first(c, path[i]);
	    } else if (typeof path[i] === 'object') {
	      if (tree && '$cursor' in path[i]) {
	        if (!type.Path(path[i].$cursor)) throw Error('baobab.getIn: $cursor path must be an array.');
	...
	function archive(size) {
	  ...
	  return {
	    add: function add(record) {
	      ...
	      if (records.length > size) records.length = size;
	    },
	    back: function back(steps) {
	      var record = records[steps - 1];

	      if (record) records = records.slice(steps);
	      return record;
	    },
	    get: function get() {
	      return records;
...
/***/ function(module, exports, __webpack_require__) {
	...
	type.FacetCursors = function (value) {
	  ...
	  return Object.keys(value).every(function (k) {
	    ...
	    return type.Path(v, ['String', 'Number', 'Object']) || v instanceof __webpack_require__(13);
	  });
	};
	...
	type.FacetFacets = function (value) {
	  ...
	  return Object.keys(value).every(function (k) {
	    ...
	    return typeof v === 'string' || v instanceof __webpack_require__(16);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Cursor(tree, path, hash) {
	  ...
	  if (this.complex) this.solvedPath = helpers.solvePath(this.tree.data, path, this.tree);

	  if (this.complex) path.forEach(function (step) {
	    if (type.Object(step) && '$cursor' in step) this._additionnalPaths.push(step.$cursor);
	  }, this);
	  ...
	  this.updateHandler = function (e) {
	    ...
	    if (self.complex) self.solvedPath = helpers.solvePath(self.tree.data, self.path, self.tree);

	    // If selector listens at tree, we fire
	    if (!self.path.length) return update(previousData);

	    // Checking update log to see whether the cursor should update.
	    if (self.solvedPath) shouldFire = helpers.solveUpdate(log, [self.solvedPath].concat(self._additionnalPaths));
	  ...
	  if (this.complex) this._lazyBind();
	}
	...
	Cursor.prototype.select = function (path) {
	  ...
	  if (!type.Path(path)) throw Error('baobab.Cursor.select: invalid path.');
	  return this.tree.select(this.path.concat(path));
	};

	Cursor.prototype.up = function () {
	  if (this.solvedPath && this.solvedPath.length) return this.tree.select(this.path.slice(0, -1));else return null;
	};
	...
	Cursor.prototype.right = function () {
	  ...
	  if (last + 1 === this.up().get(false).length) return null;
	...
	Cursor.prototype.down = function () {
	  ...
	  if (!(this.get(false) instanceof Array)) return null;
	...
	Cursor.prototype.get = function (path) {
	  ...
	  // Emitting an event
	  if (!skipEvent) this.tree.emit('get', { path: fullPath, data: data });
	...
	function pathPolymorphism(method, allowedType, key, val) {
	  if (arguments.length > 5) throw Error('baobab.Cursor.' + method + ': too many arguments.');
	  ...
	  if (!type.Path(key)) throw Error('baobab.Cursor.' + method + ': invalid path "' + key + '".');

	  // Splice exception
	  if (method === 'splice' && !type.Splicer(val)) {
	    if (type.Array(val)) val = [val];else throw Error('baobab.Cursor.splice: incorrect value.');
	  }

	  // Checking value validity
	  if (allowedType && !allowedType(val)) throw Error('baobab.Cursor.' + method + ': incorrect value.');

	  var path = [].concat(key),
	      solvedPath = helpers.solvePath(this.get(false), path, this.tree);

	  if (!solvedPath) throw Error('baobab.Cursor.' + method + ': could not solve dynamic path.');
	...
	Cursor.prototype.unset = function (key) {
	  if (key === undefined && this.isRoot()) throw Error('baobab.Cursor.unset: cannot remove root node.');
	...
	Cursor.prototype.update = function (spec, skipMerge) {
	  if (!type.Object(spec)) throw Error('baobab.Cursor.update: invalid specifications.');

	  if (!this.solvedPath) throw Error('baobab.Cursor.update: could not solve the cursor\'s dynamic path.');
	...
	Cursor.prototype.startRecording = function (maxRecords) {
	  ...
	  if (maxRecords < 1) throw Error('baobab.Cursor.startRecording: invalid maximum number of records.');
	...
	Cursor.prototype.undo = function (steps) {
	  ...
	  if (!this.recording) throw Error('baobab.Cursor.undo: cursor is not recording.');

	  if (!type.PositiveInteger(steps)) throw Error('baobab.Cursor.undo: expecting a positive integer.');

	  var record = this.archive.back(steps);

	  if (!record) throw Error('baobab.Cursor.undo: cannot find a relevant record (' + steps + ' back).');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Facet(tree, definition, args) {
	  ...
	  function refresh(complexity, targetMapping, targetProperty, mappingType, refreshArgs) {
	    if (!complexity && !firstTime) return;

	    solved = false;

	    var solvedMapping = targetMapping;

	    if (complexity) solvedMapping = targetMapping.apply(this, refreshArgs);

	    if (!mappingType(solvedMapping)) throw Error('baobab.Facet: incorrect ' + targetProperty + ' mapping.');
	    ...
	    Object.keys(solvedMapping).forEach(function (k) {
	      ...
	      if (targetProperty === 'cursors') {
	        ...
	        if (typeof solvedMapping[k] === 'string') {
	          ...
	          if (!self.facets[k]) throw Error('baobab.Facet: unkown "' + solvedMapping[k] + '" facet in facets mapping.');
	          return;
	        }
	      }
	    });
	  ...
	  this.refresh = function (refreshArgs) {
	    ...
	    if (!type.Array(refreshArgs)) throw Error('baobab.Facet.refresh: first argument should be an array.');

	    if (cursorsMapping) refresh(complexCursors, cursorsMapping, 'cursors', type.FacetCursors, refreshArgs);

	    if (facetsMapping) refresh(complexFacets, facetsMapping, 'facets', type.FacetFacets, refreshArgs);
	  };

	  // Data solving
	  this.get = function () {
	    if (solved) return facetData;

	    // Solving
	    var data = {},
	        k;

	    for (k in self.facets) data[k] = self.facets[k].get();

	    for (k in self.cursors) data[k] = self.cursors[k].get();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function merge(a, b) {
	  ...
	  if (b.$chain) {
	    ...
	    if (o.$apply) o.$apply = helpers.compose(o.$apply, b.$chain);else o.$apply = b.$chain;
	  ...
	  for (k in b) {
	    if (type.Object(b[k])) o[k] = merge(o[k], b[k]);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({
	    ...
	    render: function render() {
	        var versionNumber = this.props.version.toFixed(2);
	        return React.createElement(
	            'header',
	            null,
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controls = React.createClass({
	    ...
	    _onControlClick: function _onControlClick(e, data) {
	        debugger;
	    },
	    getDefaultProps: function getDefaultProps() {
	        return {};
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'button',
	                { onclick: this._onControlClick.bind(this, 'testButton') },
	                'TEST BUTTON'
	            ),
	            React.createElement(
	                'button',
